...
// .wrangler/tmp/bundle-J8ZMaR/strip-cf-connecting-ip-header.js
...
var src_default = {
  async fetch(request, env2) {
    ...
    if (url.pathname === "/documents") {
      try {
        const listed = await env2.DOCUMENTS_BUCKET.list({ limit: 10 });
        return new Response(
          JSON.stringify({
...
// ../../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260131.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260131.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-J8ZMaR/middleware-insertion-facade.js
...
// ../../node_modules/.pnpm/wrangler@3.114.17_@cloudflare+workers-types@4.20260131.0/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-J8ZMaR/middleware-loader.entry.ts
