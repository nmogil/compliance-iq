...
must_haves:
  truths:
    - "HTTP endpoint triggers full pipeline validation"
    - "Validation script can be run locally for testing"
    - "Validation results available in JSON and markdown formats"
  artifacts:
